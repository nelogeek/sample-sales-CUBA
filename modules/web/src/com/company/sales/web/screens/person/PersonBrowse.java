...
public class PersonBrowse extends StandardLookup<Person> {
    ...
    @Subscribe("personsTableCreate.createIndividuals")
    public void onPersonsTableCreateIndividuals(Action.ActionPerformedEvent event) {
        Individuals individuals = metadata.create(Individuals.class);
        showCreateEditor(individuals);
    }

    @Subscribe("personsTableCreate.createLegal")
    public void onPersonsTableCreateLegal(Action.ActionPerformedEvent event) {
